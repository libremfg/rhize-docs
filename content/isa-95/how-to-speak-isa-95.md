...
In Rhize, the [Equipment UI](/latest/how-to/model/master-definitions) provides an interface to model your plant according to this compositional hierarchy.
...
you can use the Rhize [GraphQL](/latest/how-to/gql) API explorer.
...
To learn more, read the Rhize guide to [Equipment relationships](resources/equipment)).
...
For example, a material lot might be a pallet of sugar from a supplier, and the sublot might be the individual sugar bags.
   ...
   To learn more, read the Rhize guide to [Material relationships](resources/material).
