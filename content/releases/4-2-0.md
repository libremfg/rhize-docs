---
title: 4.2.0
date: '2025-12-04T13:18:53-03:00'
...
#### Change
 ...
 -  Change go version to 1.23.9 from 1.23.4
 -  Change golang libraries to align with release
 -  Change library github.com/eclipse/paho.golang to v0.22.0 from v0.12.0
 -  Change library github.com/gopcua/opcua to v0.8.0 from v0.5.3
 -  Change library gitlab.com/libremfg/rhize-go/v4 to v4.0.1-rc.3
...
#### Change
 ...
 - Change BAAS container to v4.2.0-rc2
...
-  Change schema resolution of dgraph types in inherited properties to only return IIds and allow dgraph to resolve
 ...
 - Change typescript-host to v4.2.0-rc1
...
- Change Kafka implementation to allow use of Redpanda
 ...
 - Change pipeline variables to work with v4 app-config-local
...
#### Fix
 ...
 - sts/99) Fix CI pipeline failure due to creating a datasource with curl compressed
