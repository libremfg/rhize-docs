...
- posting: fix to write split-list rollups parts-first, drop non-atomic fallback
- posting: fix surface missing split-part errors instead of silently truncating iterate
