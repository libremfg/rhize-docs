...
This minor release brings changes to the Agent and Workflow services to fix backward compatibility for OIDC client auth configuration and change configuration of event sources.
