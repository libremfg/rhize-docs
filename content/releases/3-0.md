...
description: >-
  Release notes for the first general release of Rhize.
  Model production, create workflows to handle events in real time, and store it all in a knowledge graph.
categories: ["releases"]
