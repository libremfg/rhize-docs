...
To learn how to use GraphQL for manufacturing analysis, read the [Rhize guide to GraphQL]({{< relref "../latest/how-to/gql" >}}).
...
To learn more, read the [Model objects]({{< relref "../latest/how-to/model/create-objects-ui/" >}}) guide and its corresponding topic that describes the [Master definitions and fields]({{< relref "../latest/how-to/model/master-definitions/" >}}).
...
To get started, read the Guides to [Use BPMN]({{< relref "../latest/how-to/bpmn" >}}) and [Write rules]({{< relref "../latest/how-to/publish-subscribe/create-equipment-class-rule" >}}) to trigger workflows from data source values.
...
To learn more, read the guide to [Connect a data source]({{< relref "../latest/how-to/publish-subscribe" >}}) and the reference for [Agent Configuration]({{< relref "../latest/reference/service-config/agent-configuration" >}}).
...
To learn more, read the [Audit]({{< relref "../latest/how-to/audit" >}}) guide.
...
Your teams control its security and access policies, with authentication provided through [OpenID Connect]({{< relref "../latest/deploy/about-openidconnect.md" >}}).
...
Read all about how to Deploy Rhize in the [Deploy]({{< relref "../latest/deploy" >}}) guides.
...
To install, read the [Install guide]({{< relref "../latest/deploy/install" >}}).
Or, if upgrading from a release candidate, use the [Upgrade guide]({{< relref "../latest/deploy/upgrade" >}}).
