...
- [`rhize-3.0.0-checksums.txt`](https://github.com/libremfg/libremfg.github.io/blob/main/content/releases/checksums/TODO)
- [Changelog]({{< relref "/use-cases" >}}) documents the features, fixes, and refactoring that went into this release.
