...
- Add Equipment KV sync on libre-core startup
...
- Change library golang.org/x/crypto to v0.15.0 from v0.14.0
- Change library golang.org/x/net v0.18.0 from v0.16.0
- Change library golang.org/x/sync v0.5.0 from v0.4.0
- Change library golang.org/x/tools v0.15.0 from v0.14.0
