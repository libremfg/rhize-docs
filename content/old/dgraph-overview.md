...
- [`/query`]({{< relref "old/query-language/graphql-fundamentals" >}}) - used to make query requests with DQL (Alpha)
- [`/mutate`]({{< relref "old/mutations/mutations-using-curl" >}}) - used to send mutations in DQL (Alpha)
