...
Count can be used at root and [aliased]({{< relref "old/query-language/alias.md" >}}).

Query Example: Count of directors who have directed more than five films.  When used at the query root, the [count index]({{< relref "old/query-language/schema.md#count-index" >}}) is required.
...
Count can be assigned to a [value variable]({{< relref "old/query-language/value-variables.md">}}).
