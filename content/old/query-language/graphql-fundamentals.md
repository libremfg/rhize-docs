...
{{% notice "note" %}}See more about Queries in [Queries design concept]({{< relref "old/design-concepts/concepts.md#queries" >}}) {{% /notice %}}
...
In [full-text search functions]({{< relref "old/query-language/functions.md#full-text-search" >}})
