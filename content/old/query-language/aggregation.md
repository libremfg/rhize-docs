...
Aggregation can only be applied to [value variables]({{< relref "old/query-language/value-variables.md">}}).  An index is not required (the values have already been found and stored in the value variable mapping).
