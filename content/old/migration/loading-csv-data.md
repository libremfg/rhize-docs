...
[Dgraph mutations]({{< relref "old/mutations/_index.md" >}}) are accepted in RDF
...
the [JSON Mutation Format]({{< relref "old/mutations/json-mutation-format.md" >}}).
...
key]({{< relref "old/mutations/json-mutation-format.md#json-syntax-using-raw-http-or-ratel-ui"
