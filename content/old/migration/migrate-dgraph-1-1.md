...
The new [type system]({{< relref "old/query-language/type-system.md" >}}) introduced
...
For queries using [GraphQL Variables]({{< relref "old/query-language/graphql-variables.md" >}}),
