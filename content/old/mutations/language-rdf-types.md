...
```
See also [how language strings are handled in queries]({{< relref "old/query-language/graphql-fundamentals.md#language-support" >}}).
...
See the section on [RDF schema types]({{< relref "old/query-language/schema.md#rdf-types" >}}) to understand how RDF types affect mutations and storage.
