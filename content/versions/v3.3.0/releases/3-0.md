...
Your teams control its security and access policies, with authentication provided through [OpenID Connect]({{< relref "../deploy/install/keycloak" >}}).
...
- [Manufacturing data hub]({{< relref "../get-started/how-rhize-works" >}}) explains why Rhize chose its design.
