...
| username                 | If needed, username for [Agent authentication]({{< relref "../../reference/service-config" >}})    |
| password                 | If needed, password for [Agent authentication]({{< relref "../../reference/service-config" >}})    |
| certificate              | If needed, certificate for [Agent authentication]({{< relref "../../reference/service-config" >}}) |
